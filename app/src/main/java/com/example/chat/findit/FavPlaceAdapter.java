...
public class FavPlaceAdapter extends Rv{
    public FavPlaceAdapter(Context context, Cursor cursor) {
    ...
    private class FavouritePlaceCursorAdapterViewHolder extends RecyclerView.ViewHolder
        ...
        private void bindView(Cursor currentPlaceDataCursor) {
            ...
            mPlaceNameTextView.setText(currentPlaceDataCursor.getString(
                    currentPlaceDataCursor.getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_NAME)));
            ...
            mPlaceAddressTextView.setText(currentPlaceDataCursor.getString(
                    currentPlaceDataCursor.getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_ADDRESS)));
            ...
            if (currentPlaceDataCursor.getString(currentPlaceDataCursor
                    .getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_OPENING_HOUR_STATUS)).equals("true")) {
                ...
                mPlaceOpenStatusTextView.setTypeface(Typeface.createFromAsset(mContext.getAssets(),
                    ...
                    .getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_OPENING_HOUR_STATUS)).equals("false")) {
                ...
                mPlaceOpenStatusTextView.setText(currentPlaceDataCursor.getString(currentPlaceDataCursor
                        .getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_OPENING_HOUR_STATUS)));
                mPlaceOpenStatusTextView.setTypeface(Typeface.createFromAsset(mContext.getAssets(),
                        "Roboto-Regular.ttf"));
            }
            mPlaceRating.setRating(Float.parseFloat(String.valueOf(currentPlaceDataCursor
                    .getDouble(currentPlaceDataCursor
                            .getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_RATING)))));
            ...
            if (isNetworkAvailable()) {
                ...
                currentLocationDetailIntent.putExtra(Constants.LOCATION_ID_EXTRA_TEXT,
                        mCurrentDataCursor.getString(
                                mCurrentDataCursor.getColumnIndex(DetailContract.PlaceDetailEntry.COLUMN_PLACE_ID)));
