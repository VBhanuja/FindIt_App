...
public class DetailsActivity extends AppCompatActivity {
    ...
    private ArrayList<RatingByUser> mPlaceUserRatingsArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currentPlaceDetailId = getIntent().getStringExtra(Constants.LOCATION_ID_EXTRA_TEXT);
        mCurrentPlaceDetailUrl = Constants.base_url + Constants.location_detail + "/" +
                Constants.json + "?" + Constants.place_id + "=" +
                currentPlaceDetailId + "&" + Constants.key + "=" + Constants.API_KEY;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Position currentPlaceDetail = new Position(
                                    currentPlaceId,
                            ...
                            if (rootJsonObject.has("reviews")) {
                                ...
                                for (int i = 0; i < reviewJsonArray.length(); i++) {
                                    ...
                                    RatingByUser currentPlaceUserRating = new RatingByUser(
